 ...
 *
 * Responsibilities:
 * - Reads persisted appointments from the shared Zustand store (appointmentsStore).
 * - Displays a list of booked visits with doctor details, student info, and slot.
 * - Provides an empty state with a call to action if no appointments are booked yet.
 * - Allows clearing appointment history with confirmation.
 * - Supports lazy loading inside App.jsx via React.lazy and Suspense.
 */
